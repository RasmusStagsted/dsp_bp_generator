...
class BeltRouter:
    ...
    def __init__(self, buildings, x, y, input_count, output_count, product_count, selector_belt_indicies, belt_length):
        self.generate_splitters(buildings, x, y, input_count, output_count, product_count)
        self.generate_input_belts(buildings, x, y, input_count, belt_length)
        self.generate_output_and_product_belts(buildings, x, y, input_count, output_count, product_count, belt_length)
        self.generate_selector_belts(buildings, x, y, input_count, output_count, product_count, selector_belt_indicies)
        self.generate_production_belts(buildings, x, y, input_count, output_count, product_count)
        
    def generate_splitters(self, buildings, x, y, input_count, output_count, product_count):
    ...
    def generate_input_belts(self, buildings, x, y, input_count, belt_length):
        self.input_belts = []
        for i in range(input_count):
    ...
    def generate_output_and_product_belts(self, buildings, x, y, input_count, output_count, product_count, belt_length):
        self.output_belts = []
        for i in range(output_count):
    ...
    def generate_selector_belts(self, buildings, x, y, input_count, output_count, product_count, selector_belt_indicies):
        self.selector_belts = []
    ...
    def generate_production_belts(self, buildings, x, y, input_count, output_count, product_count):
